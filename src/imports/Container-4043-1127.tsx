import svgPaths from "./svg-mdwo54y3qu";
    ...
    <div className="h-[6px] relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[10.757px] items-center justify-center pr-[0.01px] relative size-full">
          <Container7 />
          <div className="flex items-center justify-center relative shrink-0 size-[12px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "0" } as React.CSSProperties}>
...
export default function Container() {
  return (
    <div className="bg-gradient-to-b content-stretch flex flex-col from-[#fafbfa] items-start pt-[40px] px-[48px] relative size-full to-white" data-name="Container">
      <Container1 />
    </div>
  );
}